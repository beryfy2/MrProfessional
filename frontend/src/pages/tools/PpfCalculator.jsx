        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-gray-900 rounded-xl shadow-2xl p-8 border border-gray-700">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Left Side - Inputs */}
              <div>
                <h2 className="text-2xl font-bold text-teal-400 mb-6">PPF Calculator</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                    ...
                    <span className="font-bold text-lg text-teal-400">{formatINR(totalInvestment || 0)}</span>
                  </div>

                  <div className="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                    <span className="font-medium text-white">Total Interest</span>
                    <span className="font-bold text-lg text-green-400">{formatINR(totalInterest || 0)}</span>
                  </div>

                  <div className="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                    <span className="font-medium text-white">Maturity Value</span>
                    <span className="font-bold text-lg text-teal-400">{formatINR(maturityValue || 0)}</span>
                  </div>
                </div>
          ...
          <div className="text-white space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="bg-gray-800 p-6 rounded-lg text-center">
                <h3 className="text-green-400 font-semibold mb-3">Guaranteed Returns</h3>
                <p className="text-gray-300 text-sm">Offers a government-backed interest rate that is typically higher than regular savings accounts.</p>
              </div>
              <div className="bg-gray-800 p-6 rounded-lg text-center">
                <h3 className="text-green-400 font-semibold mb-3">Tax Benefits</h3>
                <p className="text-gray-300 text-sm">Investments up to ₹1.5 lakh per year qualify for tax deduction under Section 80C of Income Tax Act.</p>
              </div>
              <div className="bg-gray-800 p-6 rounded-lg text-center">
                <h3 className="text-green-400 font-semibold mb-3">Protection from Creditors</h3>
                <p className="text-gray-300 text-sm">PPF accounts have immunity from attachment under court orders or debt recovery proceedings.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-green-400 font-semibold mb-4 text-center">Benefits of Using Our PPF Calculator</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <ul className="space-y-2">
                  <li className="flex items-center"><span className="text-green-400 mr-2">•</span>Instant calculation of maturity amount</li>
                  <li className="flex items-center"><span className="text-green-400 mr-2">•</span>Year-wise breakdown of interest earned</li>
                  <li className="flex items-center"><span className="text-green-400 mr-2">•</span>Helps in financial planning and goal setting</li>
                </ul>
                <ul className="space-y-2">
                  <li className="flex items-center"><span className="text-green-400 mr-2">•</span>Accurate interest calculations with the latest rates</li>
                  <li className="flex items-center"><span className="text-green-400 mr-2">•</span>Visual representation through charts</li>
                  <li className="flex items-center"><span className="text-green-400 mr-2">•</span>Comparison of different investment scenarios</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-green-400 font-semibold mb-2">Enter Yearly Investment Amount</h3>
                    <p className="text-gray-300 text-sm">Use the slider or enter a value directly to specify your annual contribution to PPF. The minimum investment allowed is ₹500, and the maximum is ₹1,50,000 per financial year.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-green-400 font-semibold mb-2">Select Investment Period</h3>
                    <p className="text-gray-300 text-sm">Choose the duration for which you plan to invest in PPF. The minimum lock-in period is 15 years, but you can extend it beyond the initial term in blocks of 5 years.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-green-400 font-semibold mb-2">View Current Interest Rate</h3>
                    <p className="text-gray-300 text-sm">The calculator displays the current PPF interest rate set by the government (7.1% as of April 2025). This rate is fixed for your calculation but may change in reality over your investment period.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-green-400 font-semibold mb-2">Analyze the Results</h3>
                    <p className="text-gray-300 text-sm">Once you input the required information, the calculator will instantly display your total investment, interest earned, and maturity value.</p>
                  </div>
                </div>
              </div>

              <div className="bg-gray-800 p-6 rounded-lg">
                <h3 className="text-green-400 font-semibold mb-4">Pro Tip:</h3>
                <p className="text-gray-300 text-sm">Try different investment amounts and time periods to see how they affect your returns. This can help you optimize your investment strategy according to your financial goals.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-white space-y-6">
            ...
            <div className="bg-gray-800 p-6 rounded-lg text-center max-w-md mx-auto">
              <div className="text-2xl font-mono text-green-400 mb-4">F = P × [(1 + i)^n - 1] / i</div>
              <p className="text-sm text-gray-300">Where:</p>
              <ul className="text-sm text-gray-300 space-y-1">
                <li><strong className="text-green-400">F</strong> = Maturity Value of PPF</li>
                <li><strong className="text-green-400">P</strong> = Annual Installment/Investment</li>
                <li><strong className="text-green-400">i</strong> = Rate of Interest (in decimal)</li>
                <li><strong className="text-green-400">n</strong> = Total Number of Years</li>
              </ul>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-green-400 font-semibold mb-3">Important Points About PPF Interest Calculation</h3>
              ...
              <div className="bg-gray-800 p-4 rounded-lg">
                <h4 className="text-green-400 font-semibold mb-2">Pro Tips to Maximize Returns</h4>
      ...
      <section className="bg-gray-900 py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-white space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-green-400 font-semibold mb-4">Who Can Open a PPF Account?</h3>
                ...
                <p className="text-sm text-gray-400 mt-2">Note: An individual can have only one PPF account in their name, except for an additional account operated as a guardian of a minor.</p>
              </div>

              <div>
                <h3 className="text-green-400 font-semibold mb-4">Account Opening & Operation</h3>
                <ul className="space-y-2 text-gray-300">
            ...
            <div>
              <h3 className="text-green-400 font-semibold mb-4 text-center">Key Features of PPF</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-gray-800 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">Lock-in Period</h4>
                  <p className="text-gray-300 text-sm">PPF has a mandatory lock-in period of 15 years. After maturity, you can extend the account in blocks of 5 years.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">Loan Facility</h4>
                  <p className="text-gray-300 text-sm">You can avail a loan against your PPF account from the 3rd financial year up to the 6th year. The loan amount is limited to 25% of the balance.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">Partial Withdrawal</h4>
                  <p className="text-gray-300 text-sm">Partial withdrawals are allowed from the 7th financial year. The maximum withdrawal amount is 50% of the balance at the end of the 4th preceding year.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">Tax Benefits</h4>
                  <p className="text-gray-300 text-sm">Investments in PPF qualify for tax deduction under Section 80C up to ₹1.5 lakh per annum. Both interest and maturity amount are tax-free.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">Protection from Creditors</h4>
                  <p className="text-gray-300 text-sm">The funds in your PPF account cannot be attached under any court order in respect of any debt or liability.</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg">
                  <h4 className="text-green-400 font-semibold mb-2">Nomination Facility</h4>
                  <p className="text-gray-300 text-sm">You can nominate one or more individuals to receive the funds in case of your demise. The nomination can be changed at any time.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray-900 py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-white">
              ...
              <table className="w-full bg-gray-800 rounded-lg">
                <thead>
                  <tr className="border-b border-gray-600">
                    <th className="text-left p-4 text-green-400">Investment Option</th>
                    <th className="text-center p-4 text-green-400">Current Returns</th>
                    <th className="text-center p-4 text-green-400">Risk Level</th>
                    <th className="text-center p-4 text-green-400">Lock-in Period</th>
                    <th className="text-center p-4 text-green-400">Tax Benefits</th>
                    <th className="text-center p-4 text-green-400">Tax on Returns</th>
                    <th className="text-center p-4 text-green-400">Liquidity</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div className="bg-blue-900 p-6 rounded-lg mt-8 text-center">
              <h3 className="text-green-400 font-semibold mb-3">Key Insight: PPF is ideal for:</h3>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="space-y-4">
            <div className="bg-gray-800 border border-green-500 rounded-lg overflow-hidden">
              ...
              >
                <span className="text-white font-medium">Can I open multiple PPF accounts?</span>
            ...
            <div className="bg-gray-800 border border-green-500 rounded-lg overflow-hidden">
              <button
                ...
                className="w-full text-left p-4 flex justify-between items-center hover:bg-gray-700 transition-colors"
              >
                <span className="text-white font-medium">What happens to a PPF account after maturity?</span>
            ...
            <div className="bg-gray-800 border border-green-500 rounded-lg overflow-hidden">
              <button
                ...
                className="w-full text-left p-4 flex justify-between items-center hover:bg-gray-700 transition-colors"
              >
                <span className="text-white font-medium">Can I withdraw money from my PPF account before maturity?</span>
            ...
            <div className="bg-gray-800 border border-green-500 rounded-lg overflow-hidden">
              <button
                ...
                className="w-full text-left p-4 flex justify-between items-center hover:bg-gray-700 transition-colors"
              >
                <span className="text-white font-medium">How is the interest on PPF calculated?</span>
            ...
            <div className="bg-gray-800 border border-green-500 rounded-lg overflow-hidden">
              <button
                ...
                className="w-full text-left p-4 flex justify-between items-center hover:bg-gray-700 transition-colors"
              >
                <span className="text-white font-medium">Is it better to invest a lump sum or monthly installments in PPF?</span>

...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Hero Section */}
            <div className="bg-[#0A3D62] text-white py-16">
            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    <div className="prose max-w-none">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Information We Collect from Website Users</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Use of the Information We Collect from Website Users</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Third Parties</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Cookies and Do Not Track</h2>
                            <p className="text-gray-700 mb-4">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Our Commitment to Children's Privacy</h2>
                            <p className="text-gray-700">

            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    <div className="prose max-w-none">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">2. Services</h3>
                        <p className="text-gray-700 mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">3. User Responsibilities</h3>
                        <p className="text-gray-700 mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">5. Refund Policy</h3>
                        <p className="text-gray-700 mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">7. Governing Law</h3>
                        <p className="text-gray-700 mb-4">
                            These terms shall be governed by and construed in accordance with the laws of India.
                        </p>

                        <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">8. Changes to Terms</h3>
                        <p className="text-gray-700 mb-4">

    ...
    return (
        <section className="bg-[var(--bg-main)] py-20">
            <div className="max-w-6xl mx-auto px-4">
                ...
                {/* Content */}
                <div className="bg-[var(--bg-secondary)] rounded-2xl p-8 md:p-12 shadow-md border border-[var(--border-color)] text-[var(--text-secondary)] text-[15px] md:text-base leading-relaxed space-y-4">
                    <p>

            ...
            <div className="container mx-auto px-4 py-12 max-w-4xl">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    <div className="prose max-w-none">
                        <h2 className="text-2xl font-bold text-gray-800 mb-6">Refund & Cancellation Policy</h2>
                        ...
                        <div className="space-y-6 text-gray-700">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">1. Refund Policy</h3>
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">2. Cancellation Policy</h3>
                                <ul className="list-disc pl-6 space-y-2">
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">3. Processing Time</h3>
                                <p>
                            ...
                            <div>
                                <h3 className="text-xl font-semibold text-gray-800 mb-2">4. Contact Us</h3>
                                <p>

...
const NavProfile = ({ hidden = false, transparent = false }) => {
    return (
        <div
            className="w-full text-[var(--text-primary)] text-sm px-6 flex items-center justify-between"
            style={{
        ...
        >
            ...
            <div className="flex items-center gap-6">
                ...
                <a href="../../public/sample.pdf" target="_blank" rel="noopener noreferrer">
                    <button className="flex items-center gap-2 bg-[var(--color-brand)] hover:bg-[var(--color-brand-hover)] text-white font-semibold px-3 py-1 rounded-xl shadow-md transition cursor-pointer">
